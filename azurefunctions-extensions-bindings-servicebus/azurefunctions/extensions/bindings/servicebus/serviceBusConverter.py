...
class ServiceBusConverter(
    ...
    def decode(cls, data: Datum, *, trigger_metadata, pytype) -> Any:
        """
        ServiceBus allows for batches to be sent. This means the cardinality can be
        one or many.
        ...
        When the cardinality is many:
            - The data is of type "collection_model_binding_data" - all events are
              sent in a single function invocation
