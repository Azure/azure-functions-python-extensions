...
from azurefunctions.agents.extensions.base import AgentCapabilities
from azurefunctions.agents.extensions.base import bindings, providers
...
def test_function_app_rejects_a_second_default_provider(tmp_path, provider):
    ...
    with pytest.raises(ValueError, match="already configured with provider"):
        bindings.configure_app(
            func_app,
            provider="langgraph",
            app_root=tmp_path,
