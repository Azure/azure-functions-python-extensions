...
class TestToolRegistry:
    ...
    def test_tool_registry_register_multiple_tools(self):
        ...
        tool_def1 = ToolDefinition(
            name="double", description="Double a number", function=tool1
        )

        tool_def2 = ToolDefinition(
            name="uppercase", description="Convert text to uppercase", function=tool2
        )
    ...
    def test_tool_registry_register_duplicate_tool(self):
        ...
        tool_def1 = ToolDefinition(
            name="duplicate_tool", description="First tool", function=tool1
        )

        tool_def2 = ToolDefinition(
            name="duplicate_tool", description="Second tool", function=tool2
        )
    ...
    def test_tool_registry_get_tool(self):
        ...
        tool_def = ToolDefinition(
            name="test_tool", description="Test tool", function=sample_tool
        )
    ...
    def test_tool_registry_list_tools(self):
        ...
        for i in range(3):
            ...
            tool_def = ToolDefinition(
                name=f"tool_{i}", description=f"Tool number {i}", function=tool_func
            )
            registry.register_tool(tool_def)
    ...
    def test_tool_registry_clear_tools(self):
        ...
        for i in range(3):
            ...
            tool_def = ToolDefinition(
                name=f"tool_{i}", description=f"Tool {i}", function=tool_func
            )
            registry.register_tool(tool_def)
    ...
    def test_tool_registry_has_tool(self):
        ...
        tool_def = ToolDefinition(
            name="check_tool", description="Tool for checking", function=sample_tool
        )
...
class TestFunctionToolManager:
    ...
    async def test_function_tool_manager_execute_tool(self):
        ...
        manager.register_tool(
            name="multiply", function=multiply, description="Multiply two numbers"
        )
    ...
    def test_function_tool_manager_list_tools(self):
        ...
        for i in range(3):
            ...
            manager.register_tool(
                name=f"tool_{i}", function=tool_func, description=f"Tool number {i}"
            )
...
class TestToolIntegration:
    ...
    def test_tool_discovery_from_multiple_sources(self):
        ...
        registry.register_tool(
            ToolDefinition(
                name="func_tool_1", description="Function tool 1", function=tool1
            )
        )

        registry.register_tool(
            ToolDefinition(
                name="func_tool_2", description="Function tool 2", function=tool2
            )
        )
