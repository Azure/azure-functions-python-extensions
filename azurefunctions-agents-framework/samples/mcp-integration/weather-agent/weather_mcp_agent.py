...
async def handle_weather_request(messages: List[ChatMessage], llm_config: LLMConfig) -> ChatMessage:
...
if __name__ == "__main__":
    ...
    async def test_agent():
        ...
        messages = [
            ChatMessage(role="user", content="What's the weather like in New York City?")
        ]
