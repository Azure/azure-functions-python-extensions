...
if __name__ == "__main__":
    ...
    async def test_agent():
        ...
        messages = [
            ChatMessage(role="user", content="Who are the most frequent contributors to this repository?")
        ]
        ...
        try:
            ...
            messages = [
                ChatMessage(role="user", content="Summarize the last change in the repository.")
            ]
